window.onload = function () {
 ...
 // ---------- 手機版選單 ---------- 結束 //
  ...
  window.addEventListener("scroll", () => {
    ...
    const newsBonus = document.querySelector(".news_bonus");
  ...
  <div class="photo_wrapper"><div class="photo_border role${
    index + 1
  }"><img class="photo"src="img/role${index + 1}_peo.png" alt=""></div></div>
  ...
  // --------------- 影視劇本 --------------- 開始 //
  const cardList = document.querySelectorAll(".card_wrapper .item");
