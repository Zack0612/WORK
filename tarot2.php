              ...
              <div id="taro-content">
                  ...
                  <div class="tarotMain">
                    <div class="tarotBack tarotMain2"></div>
                      ...
                      <div class="cardPlc">
                          <div class="title1" style="display: none;margin-bottom: 15px;">
                              請心中默想3個月內我能擺脫單身嗎？憑直覺選出1張牌
                          </div>
                          <?php
                          //隨機產生0-21的亂數排列
                          $number = range(1,22);
                          ...
                          foreach ($number as $n) {
                          ?>
                            <a class="card" href="javascript: void(0)" data-info="<?php echo $n; ?>"><img src="./images/tarot/taro-Card1.png"></a>
                          <?php
                          } //foreach ($number as $n) {
                          ?>
                          <!--
                          <a class="card" href="javascript: void(0)"><img src="./images/tarot/taro-Card1.png"></a>
                          <a class="card" href="javascript: void(0)"><img src="./images/tarot/taro-Card1.png"></a>
                          <a class="card" href="javascript: void(0)"><img src="./images/tarot/taro-Card1.png"></a>
                          <a class="card" href="javascript: void(0)"><img src="./images/tarot/taro-Card1.png"></a>
                          <a class="card" href="javascript: void(0)"><img src="./images/tarot/taro-Card1.png"></a>
...
<script>
    ...
    $(function(){
        $('.card').click(function(){
            ...
            window.location = 'tarot3.php' + '?' + 'gender=' + gender + '&' + 'number=' + val;
        });
    });
